...
namespace SE
{
	...
	typedef std::pair<uint16, uint16> InputActionDefine;
	typedef std::pair<uint16, long> InputAction;
	typedef std::vector<InputAction> InputActionsType;

// 输入动作格式
	/////////////////////////////////////////////////////////////////////////////////
	class DLL_API InputActionMap
	{
	public:
		void AddAction(InputActionDefine const& cpActionDefine);
	...
	class DLL_API CInputKeyboard : public CInputDevice
	{
	public:
		InputKeyboard();
	...
	class DLL_API CInputMouse : public CInputDevice
	{
	public:
		InputMouse();
		virtual ~InputMouse();
	...
	class DLL_API CInputJoystick : public CInputDevice
	{
	public:
		InputJoystick();
