...
public:
	...
	{
		return g_Vector4CPU_Zero;
	}

	inline static Vector4CPU &GetOne(void)
	{
		return g_Vector4CPU_One;
	}
...
inline bool operator!=(Vector4CPU const&a, Vector4CPU const&b)
{
	bool result = (a.x==b.x && a.y==b.y && a.z==b.z && a.w==b.w);
	return !result;
}
...
inline float Vector4Dotf(Vector4CPU &a, Vector4CPU &b)
{
...
inline Vector4CPU Vector4Dot(Vector4CPU &a, Vector4CPU &b)
{
...
inline Vector4CPU Vector4CrossProduct(Vector4CPU &a, Vector4CPU &b)
{
	Vector4CPU c;
