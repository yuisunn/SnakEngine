...
{
	// 計算出一個可以轉換到鏡頭座標系的矩陣
	g_view_matrix = SEMath::MatrixLookAtRH(g_eye, g_lookat, g_up);
	// 投影矩陣
	Matrix4x4 projection_matrix = SEMath::MatrixPerspectiveRH_OpenGL(90.0f, 1.0f, 0.1f, 100.0f);
	// 設定視角轉換矩陣
...
void RenderFrameOpenGL(void)
{
	...
	// 計算出一個可以轉換到鏡頭座標系的矩陣
	Matrix4x4 view_matrix = SEMath::MatrixLookAtRH(g_eye, g_lookat, g_up);
