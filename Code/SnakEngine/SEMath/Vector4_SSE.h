...
__declspec(align(16)) extern Vector4SSE g_Vector4SSE_XYZ_Mask;
__declspec(align(16)) extern Vector4SSE g_Vector4SSE_Zero;
__declspec(align(16)) extern Vector4SSE g_Vector4SSE_One;
__declspec(align(16)) extern Vector4SSE g_Vector4SSE_MinusOne;
__declspec(align(16)) extern Vector4SSE g_Vector4SSE_AbsMask;
__declspec(align(16)) extern Vector4SSE g_Vector4SSE_SignMask;
...
class  Vector4SSE
{
	...
	{
		m_Vec = _mm_and_ps(m_Vec, g_Vector4SSE_AbsMask.m_Vec);
		return *this;
	}

	inline Vector4SSE &InvertSign(void)
	{
		m_Vec = _mm_xor_ps(m_Vec, g_Vector4SSE_SignMask.m_Vec);
		return *this;
	}

	inline Vector4SSE &Saturate(void)
	{
		m_Vec = _mm_min_ps(m_Vec, g_Vector4SSE_One.m_Vec);
		m_Vec = _mm_max_ps(m_Vec, g_Vector4SSE_Zero.m_Vec);
		return *this;
	}
	...
	{
		return g_Vector4SSE_Zero;
	}

	inline static Vector4SSE &GetOne(void)
	{
		return g_Vector4SSE_One;
	}

	//inline Vector4SSE* ptr()
	//{
	//	return this;
	//}

	// operators
	inline Vector4SSE &operator=(Vector4SSE const &rhs)
	{
		m_Vec = rhs.m_Vec;
		return *this;
	}
...
{
	Vector4SSE result;
	result.m_Vec = _mm_xor_ps(rhs.m_Vec, g_Vector4SSE_SignMask.m_Vec);
	return result;
}
...
inline bool operator!=(Vector4SSE const&a, Vector4SSE const&b)
{
	__m128 r = _mm_cmpeq_ps(a.m_Vec, b.m_Vec);
	int sign_mask = _mm_movemask_ps(r);
	return sign_mask!=0xff;
...
inline float Vector4Dotf(Vector4SSE &a, Vector4SSE &b)
{
	float result;
...
inline Vector4SSE Vector4Dot(Vector4SSE &a, Vector4SSE &b)
{
	Vector4SSE c = Vector4Dotf(a, b);
	return c;
}
...
inline Vector4SSE Vector4CrossProduct(Vector4SSE &a, Vector4SSE &b)
{
	Vector4SSE result;
...
inline Vector4SSE Vector4Cross_Verify(Vector4SSE &a, Vector4SSE &b)
{
	Vector4SSE c;
...
inline Vector4SSE VectorAbs(Vector4SSE &a)
{
	...
	result.m_Vec = _mm_and_ps(a.m_Vec, g_Vector4SSE_AbsMask.m_Vec);
...
inline Vector4SSE VectorInvertSign(Vector4SSE &a)
{
	...
	result.m_Vec = _mm_xor_ps(a.m_Vec, g_Vector4SSE_SignMask.m_Vec);
...
inline Vector4SSE VectorSaturate(Vector4SSE &a)
{
	...
	result.m_Vec = _mm_min_ps(a.m_Vec, g_Vector4SSE_One.m_Vec);
	result.m_Vec = _mm_max_ps(result.m_Vec, g_Vector4SSE_Zero.m_Vec);
...
inline Vector4SSE VectorQuaternionToRotation(Vector4SSE &v)
{
	...
	float cosvalue = SEMath::ACos(v.w);
	float s = SEMath::ASin(cosvalue);
...
inline Vector4SSE VectorRotationToQuaternion(Vector4SSE &v)
{
	...
	SEMath::SinCos(radius_half, sinvalue, cosvalue);
