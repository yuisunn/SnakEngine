...
CXXFLAGS="-I$ANDROID_NDK/platforms/android-9/arch-arm/usr/include \
				-I$ANDROID_NDK/sources/cxx-stl/gnu-libstdc++/include/4.4.3 \
				-I$ANDROID_NDK/sources/cxx-stl/gnu-libstdc++/libs/armeabi/4.4.3/include \
				-I$ANDROID_NDK/sources/crystax/include"
TOOLSET=gcc-android_armeabi
...
CXXFLAGS="-I$ANDROID_NDK/platforms/android-9/arch-arm/usr/include \
				-I$ANDROID_NDK/sources/cxx-stl/gnu-libstdc++/include/4.4.3 \
				-I$ANDROID_NDK/sources/cxx-stl/gnu-libstdc++/libs/armeabi-v7a/4.4.3/include \
				-I$ANDROID_NDK/sources/crystax/include"
TOOLSET=gcc-android_armeabi_v7a
...
CXXFLAGS="-I$ANDROID_NDK/platforms/android-9/arch-x86/usr/include \
				-I$ANDROID_NDK/sources/cxx-stl/gnu-libstdc++/include/4.4.3 \
				-I$ANDROID_NDK/sources/cxx-stl/gnu-libstdc++/libs/x86/4.4.3/include \
				-I$ANDROID_NDK/sources/crystax/include"
TOOLSET=gcc-android_x86
